            ...
            <header className='w-full px-6 py-2 flex items-center justify-between fixed top-0 left-0 z-50'>
                ...
                <div className="flex items-center justify-center gap-6">
                    ...
                    <div className="relative">
                        <div className="absolute -top-[8px] -right-[8px] bg-[#FFD73B] rounded-lg duration-500" style={{ width: showBg ? "380px" : "132px", height: showBg ? "495px" : "42px", opacity: btnHovered || showBg ? 1 : 0 }} />
                        <button className='min-w-[118px] menuButton text-xl font-medium cursor-pointer -tracking-[1px]' data-hover={showBg ? "HIDE MENU" : "SHOW MENU"} onClick={handleMenu} onMouseEnter={() => setBtnHovered(true)} onMouseLeave={() => setBtnHovered(false)}>
