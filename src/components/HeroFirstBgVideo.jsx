...
// const videos = [
//     {
//         src: "/videos/design-and-branding-1-2.mp4",
...
const HeroFirstBgVideo = ({ videoLoaded }) => {
    ...
    return (
        <div className={`flex w-screen h-screen bg-white fixed top-0 left-0 z-10 duration-200 overflow-hidden ${videoLoaded ? "opacity-100 scale-100 pointer-events-auto" : "opacity-0 scale-[1.15] pointer-events-none"}`}>
            <video
                ref={videoRef}
